...
6. A Trust Badge block to showcase a summary of verified reviews (also available as a Gutenberg block)
7. A button to attach pictures to reviews
8. reCAPTCHA field to prevent fake reviews
9. A sample email with an invitation to review products
10. A sample email with a discount code
11. WooCommerce Orders page with manual reminders option enabled
12. Import reviews page
