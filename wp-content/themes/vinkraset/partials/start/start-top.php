...
<div class="wrapper-start-top">
    <div class="background center top-image cover d-md-none" style="background-image:url('<?php echo $start_top_bg_image ?>'),linear-gradient(transparent 50%,  #D9D8D6 50%);">
        <div class="container">
            <div class="row">
                <div class="col-12">
    ...
    <div class="background top top-image cover d-none d-md-block" style="background-image:url('<?php echo $start_top_bg_image_desktop ?>'),linear-gradient(transparent 50%,  #D9D8D6 50%);">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="holder-btn text-center">
